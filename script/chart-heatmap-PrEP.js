...
polygonSeries_p.dataSource.url = "https://raw.githubusercontent.com/CharlotteZKHu/hiv_twitter.github.io/main/data/state_index_PrEP_0123.json";
...
polygonTemplate_p.events.on("hit", function(ev) {
  ...
  if (data_p.id) {
    ...
    info_p.innerHTML += "Average number of HIV Prep Tweets: " + data_p.value +
    "<br>" + "Average Total: " + data_p.total;
  } else {
...
//   "<br>" + "Total: " + 9741.20;
info_p.innerHTML += "Average number of HIV PrEP Tweets: " + 1964.26 + 
  "<br>" + "Total: " + 9741.20; 
